...
## Variable importance
  ...
  After comparing the different variables between 2015 and 2019, the **lmg** approach with package @relaimpo is used for evaluating the variable importance in modelling happiness score. By using **lmg** approach to  calculate the relative contribution of each predictor to the $$R^2$$ with the consideration of the sequence of predictors appearing in the model. 
