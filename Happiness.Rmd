...
In addition, based on analyzing the relative variable importance in modeling the happiness scores with four factors which are GDP, CPI,area and population, which has indicated that GDP is the most significant factors and the area variable is strongly related to the GDP which contributes to happiness score as well. Therefore,  GDP is an essential factor for evaluating the happiness score especially for rich countries which GDP dominates the happiness scores
